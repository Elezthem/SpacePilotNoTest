...
public class DoorManager : MonoBehaviour {
	...
	void init (){
		...
		doorOpenDelay = Random.Range(0.1f + (0.4f / GameController_pilot.current_level) , (1 / GameController_pilot.current_level) ); 
		float coef = GameController_pilot.current_level;
